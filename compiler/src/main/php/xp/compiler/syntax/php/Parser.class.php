...
.    * @return  mixed result of the last reduction, if any.
    ...
    case 1:  #line 177 "grammar/php.jay"
    {
      $yyVal= new ParseTree();
    ...
    case 3:  #line 192 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new PackageNode()); } break;

    case 4:  #line 192 "grammar/php.jay"
    {
      $yyVals[-3+$yyTop]->name= $yyVals[-1+$yyTop];
    } break;

    case 7:  #line 203 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 8:  #line 204 "grammar/php.jay"
    { $yyVal= array_merge($yyVals[-1+$yyTop], array($yyVals[0+$yyTop])); } break;

    case 9:  #line 208 "grammar/php.jay"
    {
      $yyVal= $yyLex->create(new ImportNode(array('name' => $yyVals[-1+$yyTop]))); 
    } break;

    case 11:  #line 215 "grammar/php.jay"
    { $yyVal= $yyVals[-2+$yyTop].'.'.$yyVals[0+$yyTop]; } break;

    case 13:  #line 220 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 14:  #line 226 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new ClassNode(), TRUE); } break;

    case 15:  #line 226 "grammar/php.jay"
    {
    ...
    case 17:  #line 235 "grammar/php.jay"
    {
    ...
    case 18:  #line 246 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 19:  #line 247 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 20:  #line 251 "grammar/php.jay"
    { $yyVal= array(); } break;

    case 21:  #line 252 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 22:  #line 256 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 23:  #line 257 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 24:  #line 261 "grammar/php.jay"
    { $yyVal= array_merge((array)$yyVals[-1+$yyTop], $yyVals[0+$yyTop]); } break;

    case 25:  #line 262 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 26:  #line 266 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 27:  #line 267 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 28:  #line 268 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 29:  #line 272 "grammar/php.jay"
    { $yyVal= array($yyVals[-1+$yyTop]); } break;

    case 30:  #line 273 "grammar/php.jay"
    { $yyVal= array_merge(array($yyVals[-2+$yyTop]), $yyVals[0+$yyTop]); } break;

    case 31:  #line 277 "grammar/php.jay"
    { $yyVal= array($yyVals[-1+$yyTop]); } break;
    ...
    case 39:  #line 321 "grammar/php.jay"
    { $yyVal= TypeName::$VAR; } break;

    case 40:  #line 322 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 41:  #line 327 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop], $yyVals[-2+$yyTop]); } break;

    case 42:  #line 328 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop], NULL); } break;

    case 43:  #line 332 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 44:  #line 333 "grammar/php.jay"
    { $yyVal= array_merge(array($yyVals[-2+$yyTop]), $yyVals[0+$yyTop]); } break;

    case 45:  #line 337 "grammar/php.jay"
    { 
    ...
    case 47:  #line 346 "grammar/php.jay"
    { 
      $yyVal= $yyLex->create(new AnnotationNode()); 
      $yyVal->type= $yyVals[-3+$yyTop]; 
    ...
    case 48:  #line 354 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 49:  #line 355 "grammar/php.jay"
    { $yyVal= array_merge($yyVals[-2+$yyTop], $yyVals[0+$yyTop]); } break;

    case 50:  #line 359 "grammar/php.jay"
    { $yyVal= array($yyVals[-2+$yyTop] => $yyVals[0+$yyTop]); } break;

    case 51:  #line 360 "grammar/php.jay"
    { $yyVal= array($yyVals[-2+$yyTop] => $yyVals[0+$yyTop]); } break;

    case 52:  #line 364 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 53:  #line 365 "grammar/php.jay"
    { $yyVal= (array)$yyVals[-1+$yyTop]; } break;

    case 54:  #line 369 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 55:  #line 370 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 56:  #line 374 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 57:  #line 375 "grammar/php.jay"
    { $yyVal= array_merge(array($yyVals[-2+$yyTop]), $yyVals[0+$yyTop]); } break;

    case 58:  #line 379 "grammar/php.jay"
    { $yyVal= array('name' => $yyVals[-1+$yyTop], 'type' => $yyVals[-2+$yyTop], 'check' => TRUE); $yyVals[0+$yyTop] && $yyVal['default']= $yyVals[0+$yyTop]; } break;

    case 59:  #line 380 "grammar/php.jay"
    { $yyVal= array('name' => $yyVals[-1+$yyTop], 'type' => new TypeName('var'), 'check' => FALSE); $yyVals[0+$yyTop] && $yyVal['default']= $yyVals[0+$yyTop]; } break;

    case 60:  #line 388 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 62:  #line 393 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 63:  #line 394 "grammar/php.jay"
    { $yyVal= array_merge($yyVals[-1+$yyTop], $yyVals[0+$yyTop]); } break;

    case 64:  #line 398 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new ReturnNode()); } break;

    case 65:  #line 398 "grammar/php.jay"
    { 
    ...
    case 70:  #line 416 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new ForeachNode()); } break;

    case 71:  #line 416 "grammar/php.jay"
    {
    ...
    case 72:  #line 421 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new WhileNode()); } break;

    case 73:  #line 421 "grammar/php.jay"
    {
      $yyVals[-5+$yyTop]->expression= $yyVals[-2+$yyTop];
      $yyVals[-5+$yyTop]->statements= $yyVals[0+$yyTop];
    } break;

    case 74:  #line 425 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new DoNode()); } break;

    case 75:  #line 425 "grammar/php.jay"
    {
      $yyVals[-7+$yyTop]->expression= $yyVals[-2+$yyTop];
      $yyVals[-7+$yyTop]->statements= $yyVals[-5+$yyTop];
    } break;

    case 76:  #line 429 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new SwitchNode()); } break;

    case 77:  #line 429 "grammar/php.jay"
    {
      $yyVals[-7+$yyTop]->expression= $yyVals[-4+$yyTop];
      $yyVals[-7+$yyTop]->cases= $yyVals[-1+$yyTop];
    } break;

    case 78:  #line 433 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new TryNode()); } break;

    case 79:  #line 433 "grammar/php.jay"
    { 
    ...
    case 80:  #line 438 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new BreakNode()); } break;

    case 82:  #line 439 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new ContinueNode()); } break;

    case 84:  #line 440 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new ThrowNode()); } break;

    case 85:  #line 440 "grammar/php.jay"
    {
      $yyVals[-3+$yyTop]->expression= $yyVals[-1+$yyTop];
    } break;

    case 87:  #line 444 "grammar/php.jay"
    { $yyVal= $yyLex->create(new NoopNode()); } break;

    case 88:  #line 448 "grammar/php.jay"
    { $yyVal= array('key' => NULL, 'value' => $yyVals[0+$yyTop]); } break;

    case 89:  #line 449 "grammar/php.jay"
    { $yyVal= array('key' => $yyVals[-2+$yyTop], 'value' => $yyVals[0+$yyTop]); } break;

    case 90:  #line 453 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 92:  #line 458 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 93:  #line 459 "grammar/php.jay"
    { $yyVal= array_merge(array($yyVals[-1+$yyTop]), $yyVals[0+$yyTop]); } break;

    case 94:  #line 463 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new CaseNode()); } break;

    case 95:  #line 463 "grammar/php.jay"
    { 
      $yyVals[-4+$yyTop]->expression= $yyVals[-2+$yyTop];
      $yyVals[-4+$yyTop]->statements= $yyVals[0+$yyTop];
    } break;

    case 96:  #line 467 "grammar/php.jay"
    { $yyVals[0+$yyTop]= $yyLex->create(new DefaultNode()); } break;

    case 97:  #line 467 "grammar/php.jay"
    { 
      $yyVals[-3+$yyTop]->statements= $yyVals[0+$yyTop];
    } break;

    case 98:  #line 473 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 99:  #line 474 "grammar/php.jay"
    { $yyVal= $yyVals[-1+$yyTop]; } break;

    case 100:  #line 478 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 101:  #line 479 "grammar/php.jay"
    ...
    case 107:  #line 493 "grammar/php.jay"
    {
    ...
    case 108:  #line 503 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 110:  #line 508 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;
    ...
    case 112:  #line 513 "grammar/php.jay"
    { $yyVal= NULL; } break;
    ...
    case 116:  #line 531 "grammar/php.jay"
    { 
      $yyVal= new StaticMemberAccessNode(NULL, $yyVals[0+$yyTop]); 
    } break;

    case 117:  #line 534 "grammar/php.jay"
    { 
    ...
    case 125:  #line 554 "grammar/php.jay"
    {
    ...
    case 127:  #line 564 "grammar/php.jay"
    { 
    ...
    case 131:  #line 582 "grammar/php.jay"
    { 
    ...
    case 133:  #line 588 "grammar/php.jay"
    { 
      $yyVal= $yyLex->create(new UnaryOpNode($yyVals[0+$yyTop])); 
      $yyVal->postfix= TRUE; 
    } break;
    ...
    case 135:  #line 598 "grammar/php.jay"
    { 
    ...
    case 137:  #line 610 "grammar/php.jay"
    {
    ...
    case 139:  #line 620 "grammar/php.jay"
    {
    ...
    case 144:  #line 643 "grammar/php.jay"
    { $yyVal= array(); } break;

    case 146:  #line 648 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 147:  #line 649 "grammar/php.jay"
    { $yyVal= array_merge($yyVals[-2+$yyTop], array($yyVals[0+$yyTop])); } break;

    case 148:  #line 653 "grammar/php.jay"
    ...
    case 164:  #line 696 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 166:  #line 701 "grammar/php.jay"
    { $yyVal= array($yyVals[-2+$yyTop], $yyVals[0+$yyTop]); } break;

    case 167:  #line 705 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 168:  #line 706 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 169:  #line 707 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 170:  #line 708 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 171:  #line 709 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 172:  #line 710 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 173:  #line 711 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => '~='); } break;

    case 174:  #line 712 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 175:  #line 713 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 176:  #line 714 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-2+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 177:  #line 715 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-3+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-2+$yyTop].$yyVals[-1+$yyTop]); } break;

    case 178:  #line 716 "grammar/php.jay"
    { $yyVal= array('variable' => $yyVals[-3+$yyTop], 'expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-2+$yyTop].$yyVals[-1+$yyTop]); } break;

    case 179:  #line 720 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 180:  #line 721 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 181:  #line 722 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 182:  #line 723 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 183:  #line 724 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 184:  #line 725 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 185:  #line 726 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-3+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-2+$yyTop].$yyVals[-1+$yyTop]); } break;

    case 186:  #line 727 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-3+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-2+$yyTop].$yyVals[-1+$yyTop]); } break;

    case 187:  #line 731 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 188:  #line 732 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 189:  #line 733 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 190:  #line 734 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 191:  #line 735 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 192:  #line 736 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => '~'); } break;

    case 193:  #line 737 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 194:  #line 738 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 195:  #line 739 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 196:  #line 740 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 197:  #line 741 "grammar/php.jay"
    { $yyVal= array('lhs' => $yyVals[-2+$yyTop], 'rhs' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 198:  #line 745 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 199:  #line 746 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[0+$yyTop], 'op' => '~'); } break;

    case 200:  #line 747 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 201:  #line 748 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 202:  #line 749 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 203:  #line 750 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[0+$yyTop], 'op' => $yyVals[-1+$yyTop]); } break;

    case 204:  #line 754 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[-1+$yyTop], 'op' => $yyVals[0+$yyTop]); } break;

    case 205:  #line 755 "grammar/php.jay"
    { $yyVal= array('expression' => $yyVals[-1+$yyTop], 'op' => $yyVals[0+$yyTop]); } break;

    case 206:  #line 760 "grammar/php.jay"
    { $yyVal= NULL; } break;

    case 208:  #line 765 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop], $yyVals[0+$yyTop]); } break;

    case 209:  #line 766 "grammar/php.jay"
    { $yyVals[0+$yyTop][1]->target= $yyVals[-1+$yyTop]; $yyVal= array($yyVals[0+$yyTop][0], $yyVals[-1+$yyTop]); } break;

    case 210:  #line 770 "grammar/php.jay"
    ...
    case 213:  #line 773 "grammar/php.jay"
    { 
      $yyVals[-3+$yyTop]->offset= $yyVals[-1+$yyTop];
    } break;

    case 214:  #line 776 "grammar/php.jay"
    {
      $yyVal= $yyLex->create(new MemberAccessNode(NULL, $yyVals[0+$yyTop])); 
    } break;

    case 215:  #line 779 "grammar/php.jay"
    {
      $yyVal= $yyLex->create(new DynamicVariableReferenceNode(NULL, new VariableNode($yyVals[0+$yyTop]))); 
    } break;

    case 216:  #line 782 "grammar/php.jay"
    {
      $yyVal= $yyLex->create(new DynamicVariableReferenceNode(NULL, $yyVals[-1+$yyTop])); 
    } break;

    case 217:  #line 785 "grammar/php.jay"
    { $yyVals[-2+$yyTop]= $yyLex->create(new MethodCallNode(NULL, $yyVals[-1+$yyTop])); } break;

    case 218:  #line 785 "grammar/php.jay"
    { 
      $yyVals[-5+$yyTop]->arguments= $yyVals[-1+$yyTop];
    } break;

    case 221:  #line 798 "grammar/php.jay"
    { $yyVal= new TypeName($yyVals[0+$yyTop]); } break;

    case 222:  #line 802 "grammar/php.jay"
    { $yyVal= new TypeName('var[]'); } break;

    case 223:  #line 806 "grammar/php.jay"
    { $yyVal= array($yyVals[0+$yyTop]); } break;

    case 224:  #line 807 "grammar/php.jay"
    { $yyVal= array_merge(array($yyVals[-2+$yyTop]), $yyVals[0+$yyTop]); } break;

    case 225:  #line 813 "grammar/php.jay"
    { $yyVal= 0; } break;

    case 226:  #line 814 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 227:  #line 818 "grammar/php.jay"
    { $yyVal= $yyVals[0+$yyTop]; } break;

    case 228:  #line 819 "grammar/php.jay"
    { $yyVal= $yyVals[-1+$yyTop] | $yyVals[0+$yyTop]; } break;

    case 229:  #line 823 "grammar/php.jay"
    { $yyVal= MODIFIER_PUBLIC; } break;

    case 230:  #line 824 "grammar/php.jay"
    { $yyVal= MODIFIER_PROTECTED; } break;

    case 231:  #line 825 "grammar/php.jay"
    { $yyVal= MODIFIER_PRIVATE; } break;

    case 232:  #line 826 "grammar/php.jay"
    { $yyVal= MODIFIER_STATIC; } break;

    case 233:  #line 827 "grammar/php.jay"
    { $yyVal= MODIFIER_ABSTRACT; } break;

    case 234:  #line 828 "grammar/php.jay"
